...
from app.compliance import ComplianceEvaluator, ComplianceState, RuleSet
from app.vision_os.adapters.configuration.verification_rules import (
    load_verification_rules,
    rules_from_file,
)
from app.vision_os.adapters.cropping import (
...
from app.vision_os.core.model.detection import QualityGrades
from app.vision_os.core.model.ids import AttributeKey, CameraId, ClassId, ObjectId
from app.vision_os.core.model.space import Box
from app.vision_os.core.model.timebase import Duration, Instant
from app.vision_os.core.ports.cropping import (
    CLOSED_SET,
    AttributeStatus,
    TriggerCandidate,
)
...
class TestAbsentConfigurationIsSupported:
    ...
    def test_no_rules_document_means_no_evaluation(self) -> None:
        from app.compliance import load_rules
...
class TestSemanticsDoNotDependOnTheModel:
    def test_a_provider_swap_changes_no_verification_or_compliance_semantics(
        ...
        """
        import app.compliance.evaluator as evaluator_module
        from app.vision_os.adapters.cropping import verification as verification_module

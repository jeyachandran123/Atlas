...
from app.vision_os.adapters.cropping import DefaultTriggerPolicy, ExplicitRequestPolicy
...
from app.vision_os.core.ports.cropping import AttributeStatus, TriggerDecision

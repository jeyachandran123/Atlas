...
from app.vision_os.core.errors import GateRejectedError
from app.vision_os.core.model.crop import SkipReason, TriggerReason
from app.vision_os.core.model.detection import QualityLevel
...
from app.vision_os.perception.cropping import CropManager
...
class TestExtraction:
    ...
    def test_extracting_against_the_wrong_frame_is_refused(
        ...
        from app.vision_os.core.errors import FrameUnavailableError
...
class TestTriggerStateIsEphemeral:
    ...
    def test_a_second_frame_does_not_re_trigger_a_fresh_object(
        ...
        from app.vision_os.core.ports.cropping import AttributeStatus
    ...
    def test_trigger_state_is_bounded(self) -> None:
        ...
        from app.vision_os.perception.cropping import TriggerStateStore
...
def _attribute(observed_at):
    ...
    from app.vision_os.core.model.ids import ConfigRevision, ModuleId
    from app.vision_os.core.model.provenance import Provenance
    from app.vision_os.core.model.visual_object import Attribute
...
class TestAlarms:
    ...
    def test_health_degrades_when_the_budget_is_exhausted(
        ...
        from app.vision_os.core.model.health import HealthState
...
class TestSustainableFreshness:
    ...
    def test_a_zero_ceiling_reports_no_sustainable_rate(
        ...
        from app.vision_os.perception.cropping import DemandRegistry, UnderstandingBudget
...
class TestObjectsWithoutGeometry:
    def test_an_object_with_no_box_is_rejected_not_crashed(
        ...
        from app.vision_os.core.model.space import FrameOfReference, SpatialInfo

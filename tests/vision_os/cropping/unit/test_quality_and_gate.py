...
from app.vision_os.adapters.cropping import HeuristicQualityEstimator
from app.vision_os.core.model.crop import GateOutcome, GateRejection, GateResult
...
from app.vision_os.perception.cropping import GateThresholds, QualityGate

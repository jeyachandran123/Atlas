...
from app.vision_os.perception.cropping import CropRuntime
from app.vision_os.perception.registry.engine import RegistryUpdate
...
class TestExtractionFailuresStayDistinct:
    ...
    async def test_an_extraction_fault_is_counted_separately(
        ...
        from app.vision_os.core.errors import CropExtractionError
    ...
    async def test_an_unexpected_crop_error_still_becomes_a_skip(
        ...
        from app.vision_os.core.errors import BudgetExhaustedError

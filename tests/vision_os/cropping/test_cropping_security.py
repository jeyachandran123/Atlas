...
from app.vision_os.core.model.crop import Crop, PrivacyClass, RetentionMode
from app.vision_os.core.model.timebase import Duration
from app.vision_os.perception.cropping import CropDeduplicationCache
...
class TestNoBiometrics:
    ...
    def test_the_appearance_signal_is_a_scalar_not_a_vector(self) -> None:
        ...
        """
        from app.vision_os.core.ports.cropping import TriggerCandidate
...
class TestNoIdentityPersistence:
    def test_trigger_state_holds_no_identity(self) -> None:
        ...
        from app.vision_os.perception.cropping import ObjectTriggerState

...
from app.vision_os.core.model.crop import SkipReason
...
class TestBoundedResources:
    ...
    def test_the_dedup_cache_never_exceeds_its_capacity(self, manager) -> None:
        from app.vision_os.core.model.ids import CropId
    ...
    def test_the_gate_window_is_bounded(self, manager) -> None:
        ...
        from app.vision_os.perception.cropping import GateRejectionWindow

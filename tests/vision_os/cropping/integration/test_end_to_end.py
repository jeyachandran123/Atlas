...
class TestCompositionRoot:
    ...
    def test_the_gate_thresholds_come_from_configuration(self, clock) -> None:
        from app.vision_os.cropping_bootstrap import build_gate_thresholds

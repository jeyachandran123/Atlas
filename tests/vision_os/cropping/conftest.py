...
from app.vision_os.core.model.demand import (
    Demand,
    DemandBudget,
    DemandScope,
    SubjectFilter,
...
from app.vision_os.core.ports.cropping import AttributeStatus, TriggerCandidate
from app.vision_os.kernel.config.schema import CroppingSection
from app.vision_os.perception.cropping import (
    CapabilityView,
    CropManager,
    CropRuntime,
    DemandRegistry,

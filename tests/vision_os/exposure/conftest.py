...
from app.vision_os.adapters.exposure import InProcessTransport, StaticAuthorizer
from app.vision_os.adapters.exposure.authorization import full_grant, read_only_grant
from app.vision_os.adapters.persistence import (
    InMemoryEvidenceStore,
    NullEvidenceStore,
)
from app.vision_os.adapters.synthesis import AlwaysPublish, InMemoryObservationLog
from app.vision_os.core.model.api import (
    Action,
    CapabilitySummary,
    DeliveryPolicy,
    Principal,
...
from app.vision_os.core.model.crop import PrivacyClass, RetentionMode
from app.vision_os.core.model.ids import AttributeKey, CameraId, ClassId, SiteId, TenantId
from app.vision_os.core.model.timebase import Duration, Instant
from app.vision_os.core.ports.exposure import ApiLimits
from app.vision_os.core.ports.persistence import RetentionPolicy, hash_payload
from app.vision_os.exposure import AuditTrail, CountingAuditSink, ObservationApi
from app.vision_os.exposure.subscriptions import SubscriptionHub
...
def api_transport(api) -> InProcessTransport:
    ...
    """
    from app.vision_os.adapters.exposure.transport import routes_for

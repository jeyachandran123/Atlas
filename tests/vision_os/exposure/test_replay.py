...
from app.vision_os.core.model.ids import CameraId, ObjectId
from app.vision_os.core.model.timebase import Instant
from app.vision_os.state.projection import ProjectionBounds
from app.vision_os.state.replay import (
    Divergence,
    ReplayVerifier,
    compare_partitions,
...
class TestReplayReproducesTheWorld:
    ...
    def test_measured_and_believed_sightings_stay_distinct(
        ...
        from app.vision_os.core.model.observation import MeasurementBasis
...
class TestTheComparisonIsStrongEnough:
    ...
    def test_bookkeeping_differences_are_not_reported(self, state, log) -> None:
        ...
        from app.vision_os.core.model.ids import LogPosition, PartitionVersion
...
class TestNoReplayShortcutExists:
    ...
    def test_replay_calls_the_same_projection_the_live_path_calls(self) -> None:
        ...
        from app.vision_os.state import manager, projection
    ...
    def test_there_is_exactly_one_projection_function(self) -> None:
        ...
        from app.vision_os.state import projection
...
class TestRecoveryScenarios:
    ...
    def test_replay_from_a_watermark_resumes_rather_than_restarting(
        ...
        """
        from app.vision_os.core.model.ids import LogPosition

...
from app.vision_os.core.model.ids import BlobRef, ObjectId
...
class TestAuthorizationSeparations:
    ...
    def test_registering_a_demand_is_privileged(self, api, reader) -> None:
        ...
        """
        from app.vision_os.core.model.api import Action
...
class TestCoverageIsAlwaysReturned:
    ...
    def test_coverage_is_not_optional_in_the_type(self) -> None:
        ...
        from app.vision_os.core.model.api import StateResult
...
class TestEvidenceContract:
    ...
    def test_an_erased_blob_reports_expiry_not_absence(
        ...
        from app.vision_os.core.model.ids import ObjectId as OID
        from app.vision_os.core.ports.persistence import EraseScope
...
class TestVersionNegotiation:
    ...
    def test_the_supported_set_is_a_set_not_a_constant(self) -> None:
        ...
        """
        from app.vision_os.core.model.api import SUPPORTED_MAJORS
...
class TestRateLimiting:
    def test_a_consumer_exceeding_its_budget_is_shed(
        ...
        from app.vision_os.core.ports.exposure import ApiLimits, RateLimit
        from app.vision_os.exposure import ObservationApi

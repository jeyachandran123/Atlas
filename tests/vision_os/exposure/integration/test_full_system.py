...
from app.vision_os.adapters.exposure.authorization import (
    StaticAuthorizer,
    full_grant,
    read_only_grant,
)
...
from app.vision_os.core.errors import ApiError, ForbiddenError
...
class TestTheCompositionRoot:
    def test_the_layer_assembles(self, clock) -> None:
        ...
        from app.vision_os.synthesis_bootstrap import build_synthesis_layer
    ...
    def test_the_default_authorizer_denies(self, clock) -> None:
        ...
        """
        from app.vision_os.kernel.config.schema import ApiSection
    ...
    def test_a_file_store_without_a_path_is_refused_at_boot(self, clock) -> None:
        ...
        """
        from app.vision_os.core.errors import ValidationError
...
class TestNoBypasses:
    ...
    async def test_the_demand_path_is_declarative_not_a_call(self, clock) -> None:
        ...
        from app.vision_os.exposure import demands

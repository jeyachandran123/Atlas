...
from app.vision_os.adapters.synthesis import FileObservationLog, InMemoryObservationLog
from app.vision_os.core.errors import EvidenceQuotaExceededError
from app.vision_os.core.model.crop import PrivacyClass, RetentionMode
from app.vision_os.core.model.ids import BlobRef, CameraId, LogPosition, ObjectId
from app.vision_os.core.model.timebase import Instant
from app.vision_os.core.ports.persistence import (
    EraseScope,
    EvidenceQuota,
    EvidenceStatus,
    EvidenceTombstone,
...
class TestTheFourAbsenceStates:
    ...
    def test_a_fetch_cannot_report_success_with_no_bytes(self) -> None:
        ...
        from app.vision_os.core.ports.persistence import EvidenceFetch
...
class TestStorageContractsStaySeparate:
    ...
    def test_evidence_and_log_retention_are_separately_configurable(self) -> None:
        ...
        from app.vision_os.kernel.config.schema import StateSection, StorageSection

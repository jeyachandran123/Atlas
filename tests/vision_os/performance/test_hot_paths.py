...
from app.vision_os.acquisition import FrameBuffer, FrameScheduler
from app.vision_os.adapters.memory import HostMemoryPool
from app.vision_os.adapters.scheduling import CadenceAdmissionPolicy
from app.vision_os.core.model.camera import PipelineProfile, SourceSemantics
from app.vision_os.core.model.frame import FrameDimensions, PrivacyState
from app.vision_os.core.model.ids import CameraId, FrameRef, FrameSeq, ProfileId, StreamEpoch
...
from app.vision_os.core.ports.scheduling import AdmissionContext
from app.vision_os.kernel.clock import VirtualClock
from app.vision_os.kernel.config.schema import BufferSection, SchedulerSection
...
class TestNoSteadyStateGrowth:
    ...
    def test_event_bus_buffers_stay_bounded(self, clock: VirtualClock) -> None:
        from app.vision_os.kernel.events import DeliveryPolicy

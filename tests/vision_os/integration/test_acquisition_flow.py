...
from app.vision_os.core.model.frame import Frame, FrameDimensions, PrivacyState
from app.vision_os.core.model.health import ObservabilityReason
from app.vision_os.core.model.ids import CameraId, PrivacyPolicyId, StreamEpoch
...
from app.vision_os.kernel.metrics import MetricName, MetricsEngine
...
class TestSourceStatus:
    ...
    async def test_unknown_camera_status_is_typed(
        ...
        from app.vision_os.core.errors import NotFoundError

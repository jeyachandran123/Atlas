...
from app.vision_os.adapters.observability import RecordingEventTransport
from app.vision_os.bootstrap import build_platform
from app.vision_os.core.errors import CapacityExceededError, NotFoundError, ValidationError
...
from app.vision_os.kernel.runtime import RuntimeState
...
class TestCompositionRoot:
    ...
    def test_every_adapter_is_substitutable(self, clock: VirtualClock) -> None:
        ...
        platform.bus.publish(
            __import__(
                "app.vision_os.kernel.events", fromlist=["CameraChanged"]
...
class TestBootSequence:
    ...
    async def test_boot_twice_is_rejected(self, clock: VirtualClock) -> None:
        from app.vision_os.core.errors import LifecycleError
...
class TestSecretResolution:
    ...
    async def test_unresolvable_credential_fails_that_camera_only(
        ...
        from app.vision_os.core.errors import SecretResolutionError
...
class TestClockSelection:
    def test_clock_mode_is_a_deployment_decision(self, clock: VirtualClock) -> None:
        from app.vision_os.bootstrap import build_clock
        from app.vision_os.kernel.clock import ScaledClock, SystemClock
...
class TestMaintenanceLoop:
    ...
    async def test_metrics_are_exported_on_the_tick(self, clock: VirtualClock) -> None:
        from app.vision_os.adapters.observability import InMemoryMetricsExporter

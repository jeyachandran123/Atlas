...
from app.vision_os.core.errors import UnderstandingError
from app.vision_os.core.model.health import HealthState
from app.vision_os.core.model.ids import PromptId
from app.vision_os.core.model.understanding import UnderstandingOutcome
...
from app.vision_os.understanding_bootstrap import (
    build_coercion,
    ...
    def test_an_adapter_that_fails_conformance_is_never_activated(self, clock) -> None:
        ...
        class _Fabricating:
            ...
            def understand(self, request):
                ...
                from app.vision_os.core.model.understanding import ModelMeta
                from app.vision_os.core.ports.understanding import (
...
class TestEndToEnd:
    ...
    async def test_understanding_is_bounded_by_the_crop_manager(self, clock) -> None:
        ...
        await understanding.runtime.start()
        from app.vision_os.core.model.crop import EvaluationResult

...
from app.vision_os.adapters.understanding import (
    JsonCoercion,
    PromptTemplate,
    ScriptedAnswer,
...
from app.vision_os.core.model.confidence import Confidence, ConfidenceSemantics
from app.vision_os.core.model.crop import (
    Crop,
    CropTransform,
    GateResult,
    PrivacyClass,
...
from app.vision_os.core.model.detection import QualityGrades, QualityLevel
from app.vision_os.core.model.ids import (
    AttributeKey,
    CameraId,
    ClassId,
    ConfigRevision,
...
from app.vision_os.core.model.provenance import Provenance
from app.vision_os.core.model.space import Box
from app.vision_os.core.model.timebase import Duration, Instant
from app.vision_os.core.model.understanding import UnderstandingRequest
from app.vision_os.core.ports.understanding import OutputSchema, RenderedPrompt
from app.vision_os.kernel.config.schema import UnderstandingSection
from app.vision_os.perception.registry.attributes import (
    AttributeRegistry,
    AttributeSchema,
    AttributeValueType,
    Cardinality,
)
from app.vision_os.perception.understanding import (
    BoundUnderstander,
    CapabilityRouter,
    ResponseCache,
    RoutingPolicy,
...
def scripted(
    *answers: ScriptedAnswer,
    ...
    from app.vision_os.core.model.ids import ModelId
...
class LeakyUnderstander:
    ...
    def __init__(
        ...
        *,
        ...
        from app.vision_os.core.model.ids import ModelId
        from app.vision_os.core.ports.understanding import UnderstanderCapabilities
    ...
    def understand(self, request):
        ...
        from app.vision_os.core.model.understanding import ModelMeta, Timing
        from app.vision_os.core.ports.understanding import UnderstandingPortResponse
    ...
    def estimate_cost(self, request):
        from app.vision_os.core.model.understanding import CostEstimate

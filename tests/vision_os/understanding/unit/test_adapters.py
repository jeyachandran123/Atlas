...
from app.vision_os.core.errors import PromptUnavailableError
from app.vision_os.core.model.ids import AttributeKey, ClassId, PromptId
...
class TestReferenceUnderstanders:
    ...
    def test_the_unavailable_understander_always_raises(self, unavailable) -> None:
        from app.vision_os.core.errors import UnderstanderUnavailableError

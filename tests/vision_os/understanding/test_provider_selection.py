...
from app.vision_os.conformance.understanding_kits import UNDERSTANDER_KIT
from app.vision_os.core.model.ids import AttributeKey
from app.vision_os.core.ports.understanding import UnderstanderPort
...
def test_no_api_key_is_ever_defaulted_in_source():
    ...
    from app.vision_os.adapters.configuration import understander_providers as providers

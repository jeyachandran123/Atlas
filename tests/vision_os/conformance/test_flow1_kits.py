...
from app.vision_os.adapters.acquisition import (
...
from app.vision_os.adapters.memory import HostMemoryPool
from app.vision_os.adapters.observability import (
    InMemoryMetricsExporter,
    NullEventTransport,
    OpenMetricsTextExporter,
    RecordingEventTransport,
)
from app.vision_os.adapters.scheduling import (
    AdmitAllPolicy,
...
from app.vision_os.conformance import KitSection, flow1_registry
from app.vision_os.conformance.flow1_kits import (
    ADMISSION_KIT,
    ALLOCATOR_KIT,
    CLOCK_SYNC_KIT,
    DECODER_KIT,
...
from app.vision_os.core.errors import PoolExhaustedError
from app.vision_os.core.model.frame import DecodeQuality, FrameDimensions, PrivacyState
from app.vision_os.core.model.ids import PrivacyPolicyId
from app.vision_os.core.model.space import Point, Polygon
from app.vision_os.core.model.timebase import ClockQuality, Duration
from app.vision_os.core.ports.acquisition import DecodeOutcome, MaskOutcome
from app.vision_os.core.ports.scheduling import AdmissionVerdict, Fidelity
from app.vision_os.kernel.clock import VirtualClock
from app.vision_os.kernel.plugins import PortCatalogue
...
class _OverconfidentClockSync:
    ...
    def estimate(self, packet, ingest):
        from app.vision_os.core.ports.acquisition import CaptureEstimate

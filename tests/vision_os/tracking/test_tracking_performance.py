...
from app.vision_os.perception.tracking.lifecycle import LifecyclePolicy
...
class TestNoSteadyStateGrowth:
    ...
    def test_retired_ids_do_not_accumulate_without_bound(self) -> None:
        ...
        from app.vision_os.core.model.ids import TrackerEpoch
...
class TestRegression:
    ...
    def test_tenancy_comes_from_the_detection_not_the_tracker(self) -> None:
        ...
        from app.vision_os.core.model.ids import SiteId, TenantId

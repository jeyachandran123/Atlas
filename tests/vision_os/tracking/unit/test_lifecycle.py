...
from app.vision_os.core.errors import IllegalTransitionError
from app.vision_os.core.model.track import BreakReason, TrackState
from app.vision_os.perception.tracking.lifecycle import (
    LifecycleMachine,
    LifecyclePolicy,
    TransitionReason,
    check_transition,

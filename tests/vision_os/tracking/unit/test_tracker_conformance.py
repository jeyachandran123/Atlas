...
from app.vision_os.conformance.kit import KitSection
...
from app.vision_os.core.model.track import BreakReason, MeasurementBasis, TrackUpdate
...
class _FabricatesTracks(_Wrapper):
    ...
    def update(self, request) -> TrackUpdate:
        ...
        if not request.detections and not update.active:
            from app.vision_os.core.model.ids import LocalTrackId, TrackId
...
class TestDeterminismCheck:
    def test_two_identical_runs_produce_identical_tracks(self) -> None:
        ...
        from app.vision_os.conformance import DETERMINISM_CHECK

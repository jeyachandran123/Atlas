...
from app.vision_os.adapters.tracking import build_iou_tracker, build_sort_tracker
from app.vision_os.conformance import platform_registry
from app.vision_os.conformance.kit import ConformanceRegistry
...
from app.vision_os.core.model.ids import CameraId, TrackerEpoch
from app.vision_os.core.model.space import Box
from app.vision_os.core.model.track import (
    BreakReason,
    MeasurementBasis,
    TrackState,
    TrackUpdate,
)
from app.vision_os.core.ports.tracking import TrackerCapabilities, TrackerPort
from app.vision_os.kernel.events import (
    AssociationFailure,
    TrackCreated,
...
from app.vision_os.perception.tracking import TrackingEngine, TrackingManager
...
class TestManagerFallback:
    ...
    def test_the_fallback_tracker_itself_conforms(self) -> None:
        ...
        from app.vision_os.conformance import TRACKER_KIT
...
class TestRuntimeSeam:
    ...
    async def test_a_failing_sink_does_not_break_tracking(
        ...
        from app.vision_os.perception.tracking import TrackingRuntime
    ...
    async def test_health_is_reported_through_the_monitor(
        ...
        from app.vision_os.perception.tracking import TRACKING_RUNTIME_ID

...
class TestTrackerSelectionIsConfiguration:
    ...
    async def test_a_missing_kit_refuses_to_build_the_layer(self, clock) -> None:
        ...
        from app.vision_os.core.errors import TrackingError

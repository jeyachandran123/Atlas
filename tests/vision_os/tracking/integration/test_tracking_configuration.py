...
from app.vision_os.adapters.tracking import build_sort_tracker
from app.vision_os.bootstrap import build_platform
from app.vision_os.conformance import platform_registry
from app.vision_os.core.errors import ConfigurationError, TrackingError, ValidationError
...
class TestFieldsReachBehaviour:
    ...
    def test_require_deterministic_reaches_the_manager(self, clock) -> None:
        from app.vision_os.core.errors import PortIncompatibleError

...
from app.vision_os.core.errors import DetectorContractError, TaxonomyError
from app.vision_os.core.model.detection import DecisionStep
...
from app.vision_os.core.model.taxonomy import (
    UNKNOWN_CLASS,
    ClassStatus,
    MappingEntry,
    TaxonomyClass,
...
from app.vision_os.core.ports.detection import (
    DetectionResult,
    NmsDeclaration,
    RawDetection,
)
from app.vision_os.kernel.models.calibration import (
    CalibrationMethod,
    CalibrationProfile,
)
from app.vision_os.perception.detection import DetectionNormalizer, NormalizationPolicy
from app.vision_os.taxonomy import TaxonomyRegistry
...
class TestTaxonomyRegistry:
    ...
    def test_geometry_kinds_are_enforced_per_class(
        ...
        from app.vision_os.core.model.taxonomy import GeometryKind

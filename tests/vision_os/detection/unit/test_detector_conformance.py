...
from app.vision_os.adapters.detection import (
    EmptyDetector,
    ReferenceDetector,
    ScriptedDetection,
    YoloDetector,
)
from app.vision_os.adapters.models import RawBox, ScriptedSession
from app.vision_os.conformance import DETECTOR_KIT, KitSection
from app.vision_os.core.model.ids import ClassId
...
def _view(clock, width: int = 640, height: int = 360) -> FrameView:
    ...
    from app.vision_os.core.model.ids import CameraId, FrameRef, FrameSeq, StreamEpoch

...
from app.vision_os.acquisition import FrameBuffer
from app.vision_os.adapters.detection import ReferenceDetector, ScriptedDetection
...
from app.vision_os.core.model.frame import FrameDimensions, PrivacyState
from app.vision_os.core.model.ids import CameraId, ClassId, FrameRef, FrameSeq, StreamEpoch
from app.vision_os.core.model.space import Box
from app.vision_os.core.model.timebase import (
    ClockQuality,
    Duration,
    FrameTime,
)
from app.vision_os.core.ports.detection import DetectionRequest, FrameView
from app.vision_os.core.ports.scheduling import Fidelity
from app.vision_os.kernel.config.schema import (
    DetectorDeclaration,
    MappingEntryDeclaration,
)
from app.vision_os.kernel.metrics import MetricName
from app.vision_os.kernel.plugins import PluginManager
from app.vision_os.perception.detection import (
    DetectionEngine,
    DetectionManager,
    DetectionRuntime,
    DetectionScheduler,
...
class TestBatchScheduler:
    ...
    async def test_mismatched_result_count_is_caught(self, clock) -> None:
        ...
        from app.vision_os.core.errors import DetectorContractError
...
class TestDeviceWorker:
    async def test_normalises_adapter_exceptions(self, clock, scripted_detections) -> None:
        ...
        from app.vision_os.core.errors import DetectionFailedError
...
class TestDetectionRuntimeSeam:
    ...
    async def test_never_raises_even_when_the_engine_does(
        ...
        class ExplodingEngine:
            ...
            def health(self):
                from app.vision_os.core.model.health import ComponentHealth, HealthState
                from app.vision_os.core.model.ids import ModuleId
...
def _batch_key():
    from app.vision_os.perception.detection import BatchKey
...
def _result_for(view: FrameView):
    from app.vision_os.core.model.provenance import InferenceTiming, ModelMeta
    from app.vision_os.core.ports.detection import DetectionResult

...
from app.vision_os.adapters.models import (
    CpuDeviceProvider,
...
from app.vision_os.core.ports.models import ArtifactRef, DeviceInfo, DeviceKind
from app.vision_os.kernel.config.schema import DetectionSection
from app.vision_os.kernel.models import (
    CalibrationRegistry,
    DeviceBroker,
    ModelManager,
    ModelSpec,

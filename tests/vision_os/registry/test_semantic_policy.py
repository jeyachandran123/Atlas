...
from app.vision_os.adapters.understanding.payload import split_by_schema
from app.vision_os.core.errors import ConfigurationError
from app.vision_os.core.model.demand import TriggerHint
from app.vision_os.core.model.ids import AttributeKey, CameraId, ClassId
from app.vision_os.core.ports.understanding import OutputSchema
from app.vision_os.perception.registry.attributes import AttributeRegistry
from app.vision_os.perception.understanding.validation import AttributeValidator
...
def test_no_domain_vocabulary_is_written_into_the_loader():
    ...
    from app.vision_os.adapters.configuration import semantic_policy

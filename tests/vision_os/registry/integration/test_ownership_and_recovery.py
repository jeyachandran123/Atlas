...
from app.vision_os.adapters.registry import (
    SNAPSHOT_FORMAT_VERSION,
    FileObjectStore,
    InMemoryObjectStore,
)
from app.vision_os.conformance import OBJECT_STORE_KIT
from app.vision_os.core.errors import ObjectStoreError
...
from app.vision_os.core.ports.registry import (
    ObjectStorePort,
    PartitionSnapshot,
)
...
class TestCanonicalOwnership:
    ...
    def test_the_minting_call_site_is_singular(self) -> None:
        ...
        import app.vision_os.perception.registry as pkg
...
class TestRecovery:
    ...
    def _rebuild(self, clock, bus, metrics, registry_config, registry_provenance):
        from app.vision_os.perception.registry import LifecyclePolicy, ObjectRegistry
...
class TestRuntime:
    ...
    async def test_a_failing_sink_does_not_break_the_registry(
        ...
        from app.vision_os.perception.registry import RegistryRuntime
    ...
    async def test_stop_flushes_durable_state(
        ...
        from app.vision_os.kernel.config.schema import RegistrySection
        from app.vision_os.perception.registry import RegistryRuntime
    ...
    async def test_health_is_reported(self, registry_runtime, health) -> None:
        from app.vision_os.perception.registry import REGISTRY_RUNTIME_ID
...
class TestIdentityResolverStaysUnbound:
    ...
    def test_no_resolver_adapter_ships(self) -> None:
        ...
        import app.vision_os.adapters.registry as pkg
    ...
    def test_the_kit_exists_for_phase_two(self) -> None:
        ...
        from app.vision_os.conformance import IDENTITY_RESOLVER_KIT

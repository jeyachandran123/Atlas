...
from app.vision_os.adapters.registry import FileObjectStore, InMemoryObjectStore
from app.vision_os.bootstrap import build_platform
from app.vision_os.conformance import flow1_registry, platform_registry
from app.vision_os.core.errors import RegistryError
from app.vision_os.core.model.camera import Camera
from app.vision_os.core.model.frame import FrameDimensions
from app.vision_os.core.model.ids import CameraId, ClassId
from app.vision_os.core.model.space import Box
from app.vision_os.core.model.timebase import Duration
from app.vision_os.core.ports.registry import IdentityResolverPort, ResolutionResult
from app.vision_os.detection_bootstrap import build_detection_layer
from app.vision_os.kernel.config import ConfigLayer
from app.vision_os.kernel.events import ObjectCreated
from app.vision_os.perception.detection import DetectionRuntime
from app.vision_os.registry_bootstrap import (
...
def _update_from(outcome, tracker):
    ...
    from app.vision_os.core.model.ids import FrameRef as FR
    from app.vision_os.core.model.ids import FrameSeq, StreamEpoch
...
class TestCompositionRoot:
    ...
    def test_a_non_conforming_store_refuses_to_build(self, clock) -> None:
        from app.vision_os.core.ports.registry import ObjectStorePort

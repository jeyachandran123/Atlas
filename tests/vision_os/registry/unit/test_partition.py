...
from app.vision_os.core.model.ids import ClassId, ObjectId, ulid_timestamp_ms
from app.vision_os.core.model.space import Box
from app.vision_os.core.model.visual_object import BindingMethod, LifecycleState
from app.vision_os.perception.registry.lifecycle import LifecyclePolicy
from app.vision_os.perception.registry.partition import (
    ClassDistribution,
    RegistryPartition,
    spatial_distance,
)

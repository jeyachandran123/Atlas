...
from app.vision_os.core.model.ids import ObjectId, RegionId
from app.vision_os.core.model.region import ContainmentMethod, MembershipState
from app.vision_os.core.model.space import Box, Point
from app.vision_os.perception.registry.regions import (
    RegionIndex,
    RegionOccupancy,
    RegionTracker,
    containment_point,

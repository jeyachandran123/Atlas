...
from app.vision_os.core.model.observation import Observation, ObservationType
from app.vision_os.core.model.vision_state import ObjectState, RegionState, StateSnapshot
        ...
        for path, tree in modules(STATE):
            for node in ast.walk(tree):
                if isinstance(node, ast.ImportFrom) and node.module:
                    ...
                    if head == "synthesis" or node.module.startswith("app.vision_os.synthesis"):

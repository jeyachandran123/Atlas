...
from app.vision_os.core.errors import AttributeRejectedError, ValidationFailedError
...
from app.vision_os.core.model.observation import ViolationKind
from app.vision_os.kernel.events import SchemaViolationSpike
...
class TestSustainedDriftAlarms:
    ...
    def test_a_sustained_rate_alarms(
        ...
        """
        from app.vision_os.adapters.synthesis import AlwaysPublish
        from app.vision_os.synthesis import CeilingGate, ObservationBuilder

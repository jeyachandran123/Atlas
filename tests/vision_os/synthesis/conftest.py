...
from app.vision_os.adapters.synthesis import (
    AlwaysPublish,
    CollectingSink,
    ExactSuppression,
...
from app.vision_os.core.model.crop import TriggerReason
...
from app.vision_os.core.model.observation import (
    Observation,
    ObservationType,
)
from app.vision_os.core.model.provenance import ModelMeta, Provenance
from app.vision_os.core.model.space import Box, FrameOfReference, SpatialInfo
from app.vision_os.core.model.timebase import ClockQuality, Duration, Instant
from app.vision_os.core.model.understanding import (
    Timing,
    UnderstandingEvidence,
    UnderstandingOutcome,
    UnderstandingResult,
)
from app.vision_os.core.model.visual_object import (
    Attribute,
    ClassObservation,
    LifecycleState,
    VisualObject,
)
from app.vision_os.core.ports.synthesis import SuppressionPolicyPort
from app.vision_os.kernel.config.schema import StateSection, SynthesisSection
...
from app.vision_os.synthesis import (
    BuildContext,
    CeilingGate,
    ObservationBuilder,
    TaxonomyView,

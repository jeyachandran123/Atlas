...
from app.vision_os.core.model.vision_state import ConsistencyLevel
from app.vision_os.kernel.events import PartitionDegraded
...
class _FailingLog:
    ...
    def append(self, camera_id: CameraId, observations):
        from app.vision_os.core.errors import LogUnavailableError
        from app.vision_os.core.model.ids import LogPosition
        from app.vision_os.core.ports.synthesis import LogAppendResult

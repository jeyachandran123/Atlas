...
from app.vision_os.conformance import (
    OBSERVATION_LOG_KIT,
    OBSERVATION_SINK_KIT,
    SUPPRESSION_POLICY_KIT,
)
from app.vision_os.conformance.synthesis_kits import ALL_SYNTHESIS_KITS
from app.vision_os.core.model.ids import CameraId, LogPosition
from app.vision_os.core.model.observation import Observation
from app.vision_os.core.model.vision_state import ObjectState
from app.vision_os.core.ports.synthesis import (
    LogAppendResult,
    ObservationLogPort,
    ObservationSinkPort,
    SinkResult,
...
class TestEveryShippedAdapterPassesItsKit:
    ...
    def test_the_file_log_conforms(self, tmp_path) -> None:
        ...
        """
        from app.vision_os.adapters.synthesis import FileObservationLog
...
class TestSecurityBoundary:
    ...
    def test_no_state_type_holds_a_personal_identifier(self) -> None:
        ...
        """
        from app.vision_os.core.model import vision_state
    ...
    def test_the_identity_summary_is_a_claim_not_a_person(self) -> None:
        ...
        """
        from app.vision_os.core.model.vision_state import IdentitySummary
...
class _SilencesCoverage:
    ...
    def should_publish(self, candidate, previous_signature, *, elapsed, heartbeat):
        from app.vision_os.core.ports.synthesis import SuppressionDecision

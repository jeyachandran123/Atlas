...
from app.vision_os.core.errors import ProjectionError
from app.vision_os.core.model.ids import CameraId, LogPosition, ObjectId
...
from app.vision_os.core.model.vision_state import CameraPartition
from app.vision_os.core.model.visual_object import LifecycleState
from app.vision_os.state.projection import ProjectionBounds, project
...
class TestNoBusinessMeaningInState:
    def test_region_state_counts_and_does_not_judge(self) -> None:
        ...
        """
        from app.vision_os.core.model.vision_state import RegionState

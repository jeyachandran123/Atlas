...
from app.vision_os.core.errors import ObservationError
from app.vision_os.core.model.ids import ObjectId, ObservationId
...
class TestTheEnvelopeIsComplete:
    ...
    def test_a_poor_clock_floors_the_uncertainty(self, clock, metrics, bus,
        ...
        from app.vision_os.core.model.timebase import ClockQuality
...
class TestCoverageIsNeverOptional:
    ...
    def test_build_coverage_returns_an_observation_not_an_optional(self) -> None:
        ...
        from app.vision_os.synthesis import ObservationBuilder
